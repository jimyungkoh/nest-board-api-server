...
describe('CategoriesService', () => {
  ...
  describe('createCategory', () => {
    test('새로운 카테고리를 생성해야 한다', async () => {
      ...
      jest.spyOn(categoriesRepository, 'save').mockResolvedValue(savedCategory);
  ...
  describe('findCategoryBy', () => {
    test('ID로 카테고리를 찾아야 한다', async () => {
      ...
      jest.spyOn(categoriesRepository, 'findOneBy').mockResolvedValue(category);
  ...
  describe('findAllCategories', () => {
    test('모든 카테고리를 찾아야 한다', async () => {
      ...
      jest.spyOn(categoriesRepository, 'find').mockResolvedValue(categories);
  ...
  describe('deleteCategoryBy', () => {
    test('ID로 카테고리를 삭제해야 한다', async () => {
      ...
      const category = { id: categoryId, name: 'Category' };
      jest.spyOn(categoriesRepository, 'findOneBy').mockResolvedValue(category);
      jest.spyOn(categoriesRepository, 'delete').mockResolvedValue(undefined);
